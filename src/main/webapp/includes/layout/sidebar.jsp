...
<aside class="min-w-[260px] bg-white border-r" id="sidebar">
  <div class="flex flex-col shrink-0 h-screen">
    <%@ include file="../components/ui/logo.jsp" %>
    ...
    <nav class="space-y-2 flex-1 px-2 py-2">
      ...
      <a
        href="app?page=bugs"
        class="flex items-center space-x-3 p-2 rounded-md transition-color duration-300  <%= currentPage.equals("bugs") ? "bg-alternative" : "hover:bg-alternative" %>"
      >
    ...
    <div class="mt-auto border-t">
      ...
      <div class="p-4 flex flex-col gap-y-2">
        <%@ include file="../components/ui/user.jsp" %>
        <a
      ...
      <!-- Creator info -->
      <%@ include file="../components/ui/creator.jsp" %>
    </div>
  </div>
</aside>
<!-- End Sidebar -->
